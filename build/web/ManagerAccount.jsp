...
<html lang="en">
    <head>
        ...
        <link href="css/buttons.less" rel="stylesheet" type="text/css"/>
    ...
    <body>
        <div class="container">
                ...
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <form action="search2" method="post" class="form-inline my-2 my-lg-0">
                        ...
                        <c:forEach items="${listA}" var="o">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="delete2?aid=${o.id}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
            ...
            <span class="back"> <a href="home">Go Back</a></span>
